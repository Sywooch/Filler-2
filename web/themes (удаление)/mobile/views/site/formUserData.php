...
<div class="row">
	<div class="col-xs-14 <?php if ($Model -> hasErrors('ControlCode')) echo('has-error'); ?>">
		<?php
	...
	<div class="col-xs-10 cursor-pointer" title="<?php echo(Yii::t('Dictionary', 'Click to update the control code')); ?>">
		<?php
			$this -> widget('CCaptcha', array(
				'showRefreshButton' => false,
				'clickableImage' => true,
				'imageOptions' => array('width' => '300px'),
			));
		?>
	</div>
</div>
	...
	<div class="col-xs-24 indent-md text-right" id="EntryButton">
		<?php 
			echo CHtml::submitButton(($Button['Name']), array(
				'class' => 'btn btn-primary btn-lg text-48',
				'style' => 'padding-left: 50px; padding-right: 50px; width:100%; height:140px;'
			));
		?>
	</div>
</div>
