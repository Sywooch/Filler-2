...
<div class="row">
	<div class="col-xs-24 delimiter-bottom" id="header">
		...
		<div class="col-md-14 col-sm-11 hidden-xs text-center TopMenu" id="TopMenu">
			<div class="col-xs-8 text-center color-gray"><?= Yii::t('Dictionary', 'Games'); ?></div>
			<div class="col-xs-8 text-center color-gray"><?= Yii::t('Dictionary', 'Winnings'); ?></div>
			<div class="col-xs-8 text-center color-gray"><?= Yii::t('Dictionary', 'Rating'); ?></div>
